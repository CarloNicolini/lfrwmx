...
function(add_mex TARGET)
  message(STATUS "MEX Files extension  \".${MATLAB_MEX_EXT}\"")
  add_library(${TARGET} SHARED ${ARGN})
  if(WIN32)
    if (CMAKE_CL_64)
      set_target_properties(${TARGET} PROPERTIES SUFFIX ".${MATLAB_MEX_EXT}" LINK_FLAGS /export:mexFunction)
    else()
      set_target_properties(${TARGET} PROPERTIES SUFFIX ".${MATLAB_MEX_EXT}" LINK_FLAGS /export:mexFunction)
    endif()
  endif(WIN32)
  ...
  if (UNIX)
      set_target_properties(${TARGET} PROPERTIES SUFFIX ".${MATLAB_MEX_EXT}")
  endif(UNIX)
#  if (APPLE)
#    set_target_properties(${TARGET} PROPERTIES SUFFIX ".${MATLAB_MEX_EXT}")
#  endif(APPLE)
